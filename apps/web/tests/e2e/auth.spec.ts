...
specTest(
  "ARM-AUTH-002",
  "Unauthenticated GET /officer/* redirects to /login",
  async ({ page }) => {
...
specTest(
  "ARM-AUTH-004",
  "Admin can access /officer/* routes",
  async ({ page }) => {
...
specTest(
  "ARM-AUTH-007",
  "Invalid credentials show an error and do not sign in",
  async ({ page }) => {
